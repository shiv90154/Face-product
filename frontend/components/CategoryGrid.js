...
import { Star, Truck, Loader2, ArrowLeft, ChevronLeft } from 'lucide-react';
  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <Link href={backTo} className="text-[#2874f0] underline mt-4 inline-block">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          {showBackButton ? (
            ...
            <Link href={backTo} className="text-gray-600 hover:text-gray-900 transition">
              <ArrowLeft size={20} />
            </Link>
          )}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {products.map((product, index) => {
            ...
            const shouldUnoptimize = isLocalhost || imageUrl === '/placeholder.png';
              ...
              >
                ...
                <div className="px-3 pb-3 sm:px-4 sm:pb-4">
                  <button
                    ...
                    className="w-full bg-[#2874f0] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#1a5fc7] transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
