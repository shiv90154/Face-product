      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="inline-block text-2xl font-extrabold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent hover:from-gray-200 hover:to-gray-300 transition-all duration-500 transform hover:scale-105"
            >
              Brand
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 group">
                <svg className="w-5 h-5 text-gray-400 mt-0.5 group-hover:text-white group-hover:scale-110 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@brand.com" className="hover:text-white transition-colors break-all">
                  hello@brand.com
                </a>
              </li>
              <li className="flex items-start gap-3 group">
